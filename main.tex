...
In Fig. {\triangle}ABD}\ is\ a\ right\ triangle,\ right-\ angled\ at\ $\vec{A}$ \ and\ $\vec{AC}$\perp $\vec{BD}$.\ Prove\ that\  $\vec{AB^2}{=}{BC.BD}$.
...
\ In Fig. {\triangle}ABC}\ is\ circumscribing\ a\ circle.\ Find\ the\
\
...
\begin{figure}[h!]
\includegraphics[width=\linewidth]{Tri_Cir.png}
  \caption{Incircle triangle}
  \label{Incircle triangle}
\end{figure}
